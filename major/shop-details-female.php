...
$id_female=$_GET['female_id'];
$q="SELECT * FROM female WHERE female_id ='$id_female' ";
               ...
               <!-- img pasrt strat -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-2" style="background-color:; margin-left:;">
                            <div class="container">
                        ...
                        <div class="col-8" style="background-color:;">
                            <img src="<?php echo $row['pro_img_f']; ?>" class="p-2" style="width: 400px; height: 400px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <h3><?php echo $row['pro_price']; ?> <span>70.00</span></h3>
                            ...
                            <div class="product__details__cart__option">
                                ...
                                <a href="female_cart.php?female_id=<?php echo $row['female_id'];  ?>" class="primary-btn">add to cart</a>
                            </div>
