...
include 'header_a.php';
 ...
 $q=mysqli_query($conn,"SELECT * FROM man WHERE man_id='$man_id'");
...
<form method="POST" action="update.php?man_id=<?php echo $man_id; ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h2 class="p-2 mb-3" style="border-bottom:1px solid green; width: 100%;">
                  ...
                  <center>
                    <input type="submit" name="man_update" value="Update Items" class="btn btn-success mb-2" style="width:50%;">
                  </center>
            </div>
        </div>
    </div>
