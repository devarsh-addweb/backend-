...
include 'header_a.php';
 ...
 $q=mysqli_query($conn,"SELECT * FROM kids WHERE kids_id='$kids_id'");
...
<form method="POST" action="update.php?kids_id=<?php echo $kids_id; ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h2 class="p-2 mb-3" style="border-bottom:1px solid green; width: 100%;">
                  ...
                  <center>
                    <input type="submit" name="kids_update" value="Update Items" class="btn btn-success mb-2" style="width:50%;">
                  </center>
            </div>
        </div>
    </div>
