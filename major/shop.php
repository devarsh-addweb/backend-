  ...
  <!--   <section class="shop spad">
        <div class="container">
            <div class="row">
                ...
                <div class="container">
                <div class="row mt-5" style="background-color:;">
                <div class="col-lg-12">
        ...
        ?> 
         <div class="col-3 card" style="background-color:;">
            ...
            <a href="shop-details-man.php?man_id=<?php echo $row['man_id'];  ?>">
                <img src="<?php echo $row['pro_img_f']; ?>" class="p-2" style="width: 200px; height: 200px;">
            </a>
        ...
        ?> 
         <div class="col-3 card" style="background-color:;">
            <a href="shop-details-kids.php?kids_id=<?php echo $row_kids['kids_id'];  ?>">
                <img src="<?php echo $row_kids['pro_img_f']; ?>" class="p-2" style="width: 200px; height: 200px;">
            </a>
            <center>
