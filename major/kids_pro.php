		...
		while($row=mysqli_fetch_assoc($check))
		{
			?>
				<tr>
					...
					<th><a href="delete.php?kids_id=<?php echo $row['kids_id']; ?>">DELETE</a></th>
					<th><a href="kids_edit.php?kids_id=<?php echo $row['kids_id']; ?>">UPDATE</a></th>
				</tr>
			<?php
		}
	?>
